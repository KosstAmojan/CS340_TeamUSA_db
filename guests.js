module.exports = function(){
    ...
    function getGuests(res, mysql, context, complete){
        mysql.pool.query("SELECT age, firstName, guestID, heightFeet, heightInches, lastName, Parks.name as name, Guests.parkID as parkID from Guests INNER JOIN Parks on Guests.parkID = Parks.parkID", function(error, results, fields){
            if(error){
                res.write(JSON.stringify(error));
                res.end();
            }
    ...
    function getGuest(req, res, mysql, context, complete){
        var sql = "SELECT age, firstName, guestID, heightFeet, heightInches, lastName, Parks.name as name, Guests.parkID as parkID from Guests INNER JOIN Parks on Guests.parkID = Parks.parkID WHERE guestID = ?";
